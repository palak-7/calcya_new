...
const SideBar = () => {
  return (
    <aside
      id="logo-sidebar"
      className="left-0 h-screen w-64 -translate-x-full border-r border-gray-200 pt-20 transition-transform dark:border-gray-700 dark:bg-gray-800 sm:translate-x-0"
      aria-label="Sidebar"
    >
