...
const page = () => {
  return (
    <div className=" bg-white pt-10 mt-[160px] transform w-[133.33%] scale-75 origin-top-left">
      ...
      <div className="lg:mx-32 mx-7 mt-10 leading-relaxed">
        <h1 className="font-semibold text-3xl mb-4">Introduction</h1>
        ...
        <ul className=" list-disc">
          ...
          <li className="text-xl leading-loose">
            ...
            <div className="grid lg:grid-cols-3 grid-cols-1">
              <div className="hover:scale-105 p-3 border-2 border-primary text-center rounded-xl mr-4 mb-4 shadow-xl">
                ...
                <div className="font-normal lg:mx-6">
          ...
          <li>
            <h1 className="text-2xl mt-4 mb-4 font-semibold text-primary">
            ...
            <div className="grid lg:grid-cols-3 grid-cols-1">
              <div className="hover:scale-105 p-3 border-2 border-primary text-center rounded-xl mr-4 mb-4 shadow-xl">
                ...
                <div className="font-normal lg:mx-6 text-lg">
              ...
              <div className="hover:scale-105 p-3 border-2 border-primary text-center rounded-xl mr-4 mb-4 shadow-xl">
                <div className="text-xl font-semibold">Property Occupation</div>
        ...
        <div>
          ...
          <div className="grid lg:grid-cols-3 grid-cols-1 mt-2 text-xl">
            <div className="hover:scale-105 p-3 border-2 border-primary text-center rounded-xl mr-4 mb-4 shadow-xl">
              <div className="text-xl font-semibold">Rental Income</div>
              <div className="font-normal lg:mx-6">
            ...
            <div className="hover:scale-105 p-3 border-2 border-primary text-center rounded-xl mr-4 mb-4 shadow-xl">
              <div className="text-xl font-semibold">Deemed to be Let Out</div>
              <div className="font-normal lg:mx-6">
            ...
            <div className="hover:scale-105 p-3 border-2 border-primary text-center rounded-xl mr-4 mb-4 shadow-xl">
              <div className="text-xl font-semibold">Self-Occupied</div>
              <div className="font-normal lg:mx-6">
        ...
        <div className="">
          ...
          <div className="text-xl">
            ...
            <p className="text-xl mt-2 leading-loose">
            ...
            <tbody className="text-xl">
              ...
              <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                ...
                <td class="px-6 py-4">
                  ...
                  ₹30,000 under specific conditions) for self-occupied
                  properties
                </td>
              ...
              <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                ...
                <td class="px-6 py-4">
                  Property should be completed within 5 years (reduced to 3
