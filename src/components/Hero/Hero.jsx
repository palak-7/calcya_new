...
const Hero = () => {
  ...
  return (
    <>
      <section
        id="home"
        className="transfrom scale-75 w-[133.33%] origin-left relative z-10 overflow-hidden bg-white pt-[70px] md:pt-[150px]"
      >
        ...
        {/* <div className="absolute right-0 top-0 z-[-1] opacity-30 lg:opacity-100">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop offset="0.145833" stopColor="#f89b18" stopOpacity="0" />
                <stop offset="1" stopColor="#f89b18" stopOpacity="0.08" />
              </radialGradient>
              <radialGradient
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#f89b18" stopOpacity="0" />
                <stop offset="1" stopColor="#f89b18" />
              </linearGradient>
              <linearGradient
