            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                  The Compliance People: Simplifying Tax Consultation and
                  Compliance Welcome to Calcya, your trusted destination for
          ...
          >
            ...
            <defs>
              ...
              >
                ...
                <stop offset="1" stopColor="#f89b18" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
