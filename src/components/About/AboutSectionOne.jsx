...
const AboutSectionOne = () => {
  ...
  return (
    <section
      id="about"
      className="transform scale-75 width-[133.33%] origin-top lg:-mt-[500px] bg-white pb-10"
    >
          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <SectionTitle
                ...
                mb="44px"
              />
              <h1 className="mb-6 flex justify-center text-xl font-bold text-body-color">
                Why Choose Calcya
              </h1>
              <div
              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  ...
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Commitment to Compliance" />
                    <List text="Efficiency and Timeliness" />
                  </div>
                </div>
              </div>
            </div>
