        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="w-[300px] max-w-[360px] px-4 xl:mr-12">
              ...
              >
                <Image
                  src="/images/logo/cacya-logo.png"
                  alt="logo"
                  width={140}
                  height={30}
                  className="w-full"
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                {context?.user?.email == "testing@gmail.com" && (
                  <>
                    <Link
                      href="/admin"
                      className=" bg-primary p-2 shadow-three font-semibold text-white duration-300 ease-in-out hover:bg-primary/80 rounded-3xl md:block"
                    >
                      Admin
                    </Link>
                  </>
                ...
                {!context.user ? (
                  ...
                  <>
                    <Link
                      onClick={doLogout}
                      href="/signin"
                      className="bg-black lg:ml-2 ml-1 p-2 shadow-three font-semibold text-white duration-300 ease-in-out hover:bg-primary/80 rounded-3xl md:block"
                    >
                      Log Out
                    </Link>
                  </>
